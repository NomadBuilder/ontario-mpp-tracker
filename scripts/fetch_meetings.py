...
WATER_EXACT_KEYWORDS = [
    ...
    r"wastewater[\s-]?privatiz",
    r"privatiz\w{0,12}\s+(?:of\s+)?(?:the\s+)?wastewater",
...
WATER_BROAD_KEYWORDS = [
    ...
    r"(?:P3|PPP|public[\s-]?private(?:\s+partnership)?)\s+.{0,40}(?:water|wastewater)",
    r"(?:water|wastewater)\s+.{0,40}(?:P3|PPP|public[\s-]?private(?:\s+partnership)?)",
    r"outsourc\w*.{0,50}\b(?:water|wastewater)\b",
    r"\b(?:water|wastewater)\b.{0,50}outsourc",
    r"contract(?:ing)?\s+out.{0,50}\b(?:water|wastewater)\b",
    r"\b(?:water|wastewater)\b.{0,50}contract(?:ing)?\s+out",
    r"(?:private\s+operator|service\s+provider|managed\s+services?).{0,50}\b(?:water|wastewater)\b",
    r"\b(?:water|wastewater)\b.{0,50}(?:private\s+operator|service\s+provider|managed\s+services?)",
    r"alternative\s+service\s+delivery.{0,50}\b(?:water|wastewater)\b",
    r"\b(?:water|wastewater)\b.{0,50}alternative\s+service\s+delivery",
    r"operations?\s+(?:and|&)\s+maintenance.{0,40}\b(?:water|wastewater)\b",
    r"\b(?:water|wastewater)\b.{0,40}operations?\s+(?:and|&)\s+maintenance\s+contract",
    r"\bveolia\b",
    r"\bsuez\b.{0,40}(?:water|wastewater)",
    r"american\s+water\s+(?:works|company)",
    r"\bepcor\b",
    r"waterworks\s+(?:sale|privat|concession|transfer)",
    r"corporatiz\w*\s+(?:water|wastewater)",
    r"(?:water|wastewater)\s+corporatiz",
    r"concession\s+agreement.{0,50}\b(?:water|wastewater)\b",
    r"\b(?:water|wastewater)\b.{0,50}concession\s+agreement",
    r"bulk\s+water\s+(?:sale|export|agreement)",
    r"water\s+franchise",
    r"wastewater\s+franchise",
]
